...
export function Button({ variant = "primary", size = "md", loading = false, disabled, className, children, ...props }: ButtonProps) {
  ...
  const variants = {
    primary: "bg-gradient-to-r from-[#16a34a] to-[#22c55e] text-white hover:from-[#15803d] hover:to-[#16a34a] active:from-[#166534] disabled:opacity-40 shadow-lg shadow-green-900/20",
    secondary: "bg-[#141414] text-[#999] border border-[#222] hover:bg-[#1a1a1a] hover:text-[#ccc] hover:border-[#333] active:bg-[#111] disabled:opacity-40",
    danger: "bg-[#dc2626] text-white hover:bg-[#b91c1c] disabled:opacity-40",
    ghost: "bg-transparent text-[#666] hover:text-[#ccc] hover:bg-[#141414] active:bg-[#111] disabled:opacity-40",
  };
  const sizes = {
