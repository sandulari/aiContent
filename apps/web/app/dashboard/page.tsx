...
function DateRangePicker({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1.5 z-50 w-72 bg-[#161b22] border border-[#21262d] rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.1)] overflow-hidden">
          {/* Preset buttons */}
              ...
              <div className="grid grid-cols-7">
                {calendarDays.map((day, i) => {
                  ...
                  const stripBg = isInRange || isStart || isEnd
                    ? isStart && isEnd ? ""
                    : isStart ? "bg-[#58a6ff]/10 rounded-l-lg"
                    : isEnd ? "bg-[#58a6ff]/10 rounded-r-lg"
                    : "bg-[#58a6ff]/10"
                    : "";
                    ...
                    <div key={i} className={`relative flex items-center justify-center ${stripBg} transition-all duration-200`}>
                      <button
                        ...
                        className={[
                          ...
                          isStart ? "bg-[#58a6ff] text-[#0d1117] font-bold" : "",
                          isEnd ? "bg-[#58a6ff] text-[#0d1117] font-bold" : "",
                          isInRange && !isStart && !isEnd ? "text-[#58a6ff] font-medium" : "",
...
function StatCard({
  ...
  return (
    <div className="bg-[#161b22] border border-[#21262d] rounded-lg p-4">
      ...
      {!isZero && (
        <div className={`inline-flex items-center gap-1 mt-1.5 text-xs ${isPositive ? "text-[#3fb950]" : "text-[#f85149]"}`}>
  ...
  return (
    <div className="min-h-screen bg-[#0d1117]">
      <div className="p-6 max-w-6xl mx-auto">
        ...
        {/* No data banner */}
        {showNoDataBanner && (
          <div className="mb-6 p-4 bg-[#161b22] border border-[#21262d] rounded-lg">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  {exports.map((exp) => (
                    <div
                      key={exp.id}
                      className="bg-[#161b22] border border-[#21262d] rounded-lg p-4 flex items-center justify-between"
                    >
